...
args = dict(
	...
	pretrained_model_path = os.path.join(OUTPUT_DIR, 'mujoco',
							'model=allenai/uio2-large_resize_factor=1.0_batchsize=24_lr=0.001_with_prompt_and_gt_randomization_internal_scale_aug=2,0.5',
						  	'num_train_epoch=50', 
						  	'depth={args[train_dataset][kwargs][use_depth]}',
							'checkpoint.pth'),
